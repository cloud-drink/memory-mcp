...
function buildPayload(sessionId, projectId) {
...
async function runDeepSeekSummarizer(payload) {
...
function runExternalSummarizer(command, payload) {
...
export async function summarizeSession(sessionId, projectId) {
